...
/* 1.WRITE A SQL QUERY TO FIND THE NUMBER OF FEMALE PASSENGERS
 WHO HAVE MADE BOOKINGS FOR AIR TICKETS?
*/
...
SELECT COUNT(*) AS BUSINESS_CLASS_BOOKED FROM AIRLINE WHERE CLASS='Business';
